...
class Application_Model_TypistsDefaultShiftMapper extends Application_Model_DefaultShiftMapper
{
	protected $_name = 'typists_default_shift';
    ...
    public function removeShift($shiftId)
    {
        ...
        $db->delete('typists_shifts', 'shift_id = ' . $shiftId);
        $db->delete('audio_jobs_typists', 'shift_id = ' . $shiftId);
    }
